...
class search_http_body_to_ip(DiscoverableTransform):
    ...
    def create_entities(cls, request, response):
        ...
        response = Censys(api_id, api_secret, max_pages=env_config.get('max_pages', 1)).search_http_body_to_ip(
            body_text=ev,
...
if __name__ == "__main__":
    ...
    Censys(censys_api_id, censys_api_secret).search_http_body_to_ip(
