...
class search_domain_to_ipv4(DiscoverableTransform):
    ...
    def create_entities(cls, request, response):
        ...
        response = Censys(api_id, api_secret, max_pages=env_config.get('max_pages', 1)).search_domain_to_ipv4(
            domain_name=ev,
...
if __name__ == "__main__":
    ...
    Censys(censys_api_id, censys_api_secret).search_domain_to_ipv4(
        domain_name=ev, object_properties=ep
    )
