...
class search_issuer_cn_to_certificate_hash(DiscoverableTransform):
    ...
    def create_entities(cls, request, response):
        ...
        response = Censys(
            api_id,
            api_secret,
            max_pages=env_config.get('max_pages', 1)
        ).search_issuer_cn_to_certificate_hash(
            issuer_cn=ev,
...
if __name__ == "__main__":
    ...
    Censys(censys_api_id, censys_api_secret).search_issuer_cn_to_certificate_hash(
