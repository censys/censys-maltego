...
class search_ipv4_to_ports(DiscoverableTransform):
    ...
    def create_entities(cls, request, response):
        ...
        response = Censys(api_id, api_secret, max_pages=env_config.get('max_pages', 1)).search_ipv4_to_ports(
            ip_address=ev,
...
if __name__ == "__main__":
    ...
    Censys(censys_api_id, censys_api_secret).search_ipv4_to_ports(
